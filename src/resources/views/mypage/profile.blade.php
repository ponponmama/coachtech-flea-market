        ...
        <div class="auth-content">
            <form action="{{ route('') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="profile-input" type="postal_code" name="postal_code" id="postal_code" value="{{ old('postal_code') }}" autocomplete="postal_code">
                </div>
                <p class="form__error">
                    @error('postal_code')
                        {{ $message }}
                ...
                <div class="form-group">
                    ...
                    <input class="profile-input" type="address" name="address" id="address" value="{{ old('address') }}" autocomplete="address">
                </div>
                <p class="form__error">
                    @error('address')
                        {{ $message }}
                ...
                <div class="form-group">
                    ...
                    <input class="profile-input" type="building_name" name="building_name" id="building_name" value="{{ old('building_name') }}" autocomplete="building_name">
                </div>
                <p class="form__error">
                    @error('building_name')
                        {{ $message }}
