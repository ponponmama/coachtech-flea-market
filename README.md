...
- **機能テスト**
  ...
  - `TransactionChatTest.php` - 取引チャット確認機能テスト（7 項目）

    - マイページから取引中の商品を確認することができる（ID: FN001）
    - 未読メッセージ数をマイページで確認することができる（ID: FN002）
    - マイページから取引チャット画面に遷移することができる（ID: FN003）
    - サイドバーから他の取引チャット画面に遷移することができる（ID: FN004）
  ...
  - `TransactionRatingTest.php` - 取引評価機能テスト（6 項目）
